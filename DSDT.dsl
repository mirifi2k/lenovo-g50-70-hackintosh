...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_GPE.OSUP, MethodObj)    // 1 Arguments (from opcode)
    ...
    External (_SB_.PCI0.GFX0.CADL, FieldUnitObj)    // (from opcode)
    ...
    External (_SB_.PCI0.RP05.LNKD, FieldUnitObj)    // (from opcode)
    ...
    External (AR08, IntObj)    // (from opcode)
    ...
    External (PR08, IntObj)    // (from opcode)
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0xAAFBCA98, 0x02F6)
    ...
    OperationRegion (OGNS, SystemMemory, 0xAAFBBF98, 0x0F)
                ...
                Device (EC0)
                {
                    ...
                    Device (BAT0)
                    {
                        ...
                        Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                        {
                            If (LEqual (ECON, One))
                            {
                                Store (B1B2 (CD00, CD01), Local0)
                                Multiply (Local0, 0x0A, Local0)
                                Store (Local0, Index (PBIF, One))
                                Store (B1B2 (CF00, CF01), Local0)
                                Multiply (Local0, 0x0A, Local0)
                                Store (Local0, Index (PBIF, 0x02))
                                Store (B1B2 (CE00, CE01), Index (PBIF, 0x04))
                        ...
                        Method (_BST, 0, Serialized)  // _BST: Battery Status
                        {
                            If (LEqual (ECON, One))
                            {
                                ...
                                Store (OBAC, OBPR)
                                Sleep (0x10)
                                Store (B1B2 (CA00, CA01), OBRC)
                                Sleep (0x10)
                                Store (B1B2 (CB00, CB01), OBPV)
...
\rmdt.p1("EC _Q67 exit")
                ...
                Scope (\)
                {
                    OperationRegion (COMP, SystemMemory, 0xAAFBEC98, 0x0200)
